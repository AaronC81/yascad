...
impl Display for RuntimeErrorKind {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            RuntimeErrorKind::ChildOutOfRange(index) => write!(f, "no child at index {index}"),
            ...
            RuntimeErrorKind::CannotRotate2DGeometryOnAxis => write!(f, "2D geometry may only be rotated around the Z axis"),
